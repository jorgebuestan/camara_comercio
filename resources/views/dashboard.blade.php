...
<html class="fixed sidebar-left-collapsed">
	<head>
		...
		<style>
			...
			.m-btn {
				background-color: #264025; /* Cambia el color de fondo */
				color: white; /* Cambia el color del texto */ 
			}
			.r-btn {
				background-color: #4C804A; /* Cambia el color de fondo */
				color: white; /* Cambia el color del texto */ 
			}
			.b-btn {
				background-color: #73C070; /* Cambia el color de fondo */
				color: white; /* Cambia el color del texto */ 
			}
			.mb-btn {
				background-color: #79CC76; /* Cambia el color de fondo */
				color: white; /* Cambia el color del texto */ 
			}
		</style>
	...
	<body>
		...
		.url-container a {
			color: #242B4E; /* Cambia el color del texto del enlace dentro del contenedor */
		...
		<script src="{{URL::asset('porto/vendor/datatables/extras/TableTools/Buttons-1.4.2/js/dataTables.buttons.min.js') }}"></script>
		<script src="{{URL::asset('porto/vendor/datatables/extras/TableTools/Buttons-1.4.2/js/buttons.bootstrap4.min.js') }}"></script>
		<script src="{{URL::asset('porto/vendor/datatables/extras/TableTools/Buttons-1.4.2/js/buttons.html5.min.js') }}"></script>
		<script src="{{URL::asset('porto/vendor/datatables/extras/TableTools/Buttons-1.4.2/js/buttons.print.min.js') }}"></script>
