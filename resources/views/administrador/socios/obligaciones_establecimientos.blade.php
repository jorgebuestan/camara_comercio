...
@section('content')
    ...
    <script>
        $(document).ready(function() { 
            ...
            let establecimiento_socio_selected = null; 
            ...
            $(document).on('click', '.edit-modal', function() {
                ...
                $.ajax({
                    ...
                    method: 'GET',
                    success: function(response) { 
                        establecimiento_socio_selected = response;
                        console.log('Datos recibidos:', response);
            ...
            $('#btn-more-info').on('click', function() {
                let camaraLogInsert = establecimiento_socio_selected.insert;
                let camaraLogUpdate = establecimiento_socio_selected.update;
